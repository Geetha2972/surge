...
public class TaskEventHandler2 implements EventHandler {
    private static final Logger LOG = LoggerFactory.getLogger(TaskEventHandler2.class);
    ...
    private ResourceResolver getServiceResourceResolver() throws Exception {
        Map<String, Object> params = Collections.singletonMap(ResourceResolverFactory.SUBSERVICE, "root");
